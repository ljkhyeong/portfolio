    ...
    cal: {
        nodes: [
            ...
            node(
                ...
                96,
                "iCalendar",
                ["조건부 요청 확인", "ETag 및 수정 시각"],
                "step",
            ),
            node("feed", 792, 72, 144, 96, "200 응답", ["본문 필요", ".ics 본문"], "result"),
            node("cache", 792, 272, 144, 96, "304 응답", "캐시 유효", "result"),
            node(
                "token",
                552,
                272,
        ...
        edges: [
            ...
            edge("M636 272 V168", "유효한 토큰", 684, 224),
        ],
    },
    round: {
        nodes: [

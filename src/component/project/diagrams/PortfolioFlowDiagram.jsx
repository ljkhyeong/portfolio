...
const diagrams = {
    ...
    "intent-trace": {
        ...
        description:
            "사용자 요청, 변경 근거와 출처를 전체 커밋 해시, 파일, 코드 줄과 검증 결과에 연결합니다. 작성자 확인과 현재 코드 상태 일치를 확인해 공개하고, 이후 코드가 바뀌면 공개 상태를 다시 검사해 기존 기록을 차단하는 흐름입니다.",
        height: 520,
        zones: [
            { x: 24, y: 40, width: 176, height: 400, label: "입력", labelWidth: 56 },
            { x: 232, y: 40, width: 464, height: 400, label: "변경 기록", labelWidth: 88 },
            { x: 728, y: 40, width: 208, height: 400, label: "공개 여부 확인", labelWidth: 112 },
        ],
        nodes: [
            {
                id: "request",

    ...
    (project.services ?? []).map((service) => ({
        ...projectSource(project, {
            ...
            content: joinContent([
                ...
                labeledContent("트레이드오프", service.tradeoff),
            ]),
    ...
    return [
        projectSource(project, {
            ...
            content: joinContent([
                ...
                labeledContent("트레이드오프", project.architecture.tradeoff),
            ]),
        ...
        return {
            ...projectSource(project, {
                ...
                content: joinContent([
                    ...
                    labeledContent("트레이드오프 및 범위", problem.boundary),
                ]),

...
const projects = [
    ...
    },
    {
        ...
        proofs: [
            {
                ...
                scope: "로컬 개발 브랜치 5675733 · 전체 서울 정책과 최종 신청 자격 판정은 아님",
            },
            {
            ...
            },
            {
                ...
                scope: "공개 main 1b7fbdd와 로컬 개발 브랜치 5675733 · 실제 관리자 계정 연결은 미완료",
            },
        ],
        category: "개인 웹앱 프로젝트",
        ...
        status: {
            label: "현재 상태",
            text: "공개 main 1b7fbdd에서 접수 상태·개인 조건 검색과 관리자 수집 예외를 구현했고, 로컬 DB의 공개 정책 40건을 확인했습니다. 로컬 개발 브랜치 5675733에는 정책 9종의 조건 질문, 7종의 연령 비교와 원문 충돌 안내를 추가했습니다. 실제 OAuth·이메일·AI 공급자와 관리자 계정은 미검증입니다.",
        },
        visualCaption:

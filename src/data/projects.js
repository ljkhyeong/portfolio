    ...
    },
    {
        ...
        problems: [
            ...
            },
            {
                ...
                constraint:
                    "Spring Boot Actuator, Prometheus, Grafana 같은 모니터링 도구를 추가하기 어려웠고, JUnit과 AssertJ 기반 자동화 테스트도 구축되어 있지 않은 폐쇄망 레거시 환경이었습니다. 변경 영향을 자동 검증하기 어려운 데다 화면 오류의 원인이 요청 처리, SQL, 기관 연계 배치 또는 DB 반영 중 어디에 있는지 바로 알기 어려웠습니다.",
                decision:

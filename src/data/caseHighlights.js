export const caseIntroductions = {
    baton: "조직의 역할, 반복 업무와 인수인계를 관리하는 플랫폼입니다.",
    happygallery: "공방 상품 주문과 클래스 예약 서비스입니다.",
    "hope-commit": "기존 Hope 플러그인을 포크해 로컬 커밋 비교와 HTML 리뷰 기능을 보완했습니다.",
...
const highlights = {
    ...
    happygallery: [
        "결제 중복 실행, 알림 유실과 예약 및 재고 초과",
        "결제 키 재사용, DB 알림 재처리와 행 잠금 적용",
        "결제 및 알림 통합 테스트 확인. 실제 Toss 및 NHN 연동은 미검증",
    ],
    "hope-commit": [
        "지정한 커밋 밖의 코드가 섞이고 변경 줄 근거가 없는 리뷰",
        "Hope 3.0.3을 포크해 커밋 범위 고정과 줄 근거 검증 추가",
        "공개 main 4.0.0 자동화 테스트 275개 통과",
    ],
    "intent-trace": [
        "커밋만으로 확인하기 어려운 AI 코드 변경 이유와 검증 결과",
        "요청과 코드 위치를 기록하고 작성자 확인 뒤 코드 변경 시 공개 차단",
        "공개 main CI 통과 및 v0.6.0 JAR 공개. Marketplace와 공개 운영은 미검증",
    ],
    warrant: [

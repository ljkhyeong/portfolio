export const projectSummaries = [
    ...
    },
    {
        ...
        summary:
            "공방 고객이 작품을 주문하고 클래스를 예약하며, 관리자가 상품, 재고, 일정과 주문 상태를 처리하는 서비스입니다. 결제 및 환불 요청 ID로 중복 처리를 막고, 결과를 확인할 수 없으면 결제사에서 기존 처리 결과를 다시 조회한 뒤 복구 배치로 재처리합니다. 외부 배송조회 등록 실패는 배치로 다시 처리하고, 택배사 배송 완료와 관리자의 주문 완료를 분리했습니다. 옵션별 재고는 항상 같은 순서로 잠근 뒤 차감했으며 AWS 운영 이력이 있습니다.",
        homeFacts: [
            {
                label: "담당",
    ...
    },
    {
        ...
        homeFacts: [
            ...
            {
                label: "해결",
                value: "입력 커밋과 일반, 최초 및 병합 커밋별 규칙으로 확정한 비교 기준의 파일만 수집하고, 설명이 실제 변경 줄을 가리킬 때만 새 HTML 생성",
            },
        ],
